...
namespace Mkey
{
 ...
 currentStepLevel2 = TutorialStepLevel2.Step1_Button;
        ...
        private void OnLevel2Step1BtnDone()
        {
            ...
            ShowLevel2Step();
            PorkTruckRevere.AirExpertly().FastTruck("1002");
        }
        // 第二关麻将牌点击处理（完全隔离）
        ...
        {
            var maskPanel = GetComponentInChildren<EachToolBelle>(true);
            if (maskPanel != null)
            {
