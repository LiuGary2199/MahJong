...
public class PoemSeal
{
    public static long Zealand()
    {
        return AirSomewhere(DateTime.Now);
    }

    public static long AirSomewhere(DateTime datetime)
    {
    ...
    /// <returns></returns>
    public static string PoemLoveLizard(DateTime dt, string format)
    {
        return dt.ToString(format);
    }

    public static DateTime InquireUpPoemLove(long seconds)
    {
        DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)); // 当地时区
    ...
    /// <returns></returns>
    public static string InquireLizard(long totalTime, string connector = ":")
    {
    ...
    /// <param name="totalTime"></param>
    /// <returns></returns>
    public static string InquireLizard2(long totalTime)
    {
        int seconds = Mathf.Max((int)(totalTime % 60), 0);
        int minutes = Mathf.Max((int)(totalTime / 60) % 60, 0);
