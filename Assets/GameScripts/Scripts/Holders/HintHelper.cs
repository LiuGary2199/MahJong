...
namespace Mkey
{
	...
	public class HintHelper : MonoBehaviour
	{
		...
		public void Select_Hint()
		{
			...
			{
				UIExplain.AirExpertly().HaleUIProwl(nameof(Evoke), "already been selected");
			...
			ADExplain.Expertly.FoilTorporWeary((success) =>
			{
				if (success)
				{
					...
					PorkTruckRevere.AirExpertly().FastTruck("1005");
			...
			{
				ADExplain.Instance.playRewardVideo((success) =>
				{
					if (success)
					{
						HintHolder.Add(1);
