...
public class AxeShipSlaveBelle : CoaxUIProwl
{
    public static AxeShipSlaveBelle instance;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    private float MasterSolve= 1;
    private float MasterWeight= 1;
    public void User(GameObject _target)
    {
        ...
        else
        {
            ...
            Holland[0] = new Vector3(pos.x - MasterSolve, pos.y - MasterWeight);
            Holland[1] = new Vector3(pos.x - MasterSolve, pos.y + MasterWeight);
            Holland[2] = new Vector3(pos.x + MasterSolve, pos.y + MasterWeight);
            Holland[3] = new Vector3(pos.x + MasterSolve, pos.y - MasterWeight);
        }
        //计算高亮显示区域在画布中的范围
